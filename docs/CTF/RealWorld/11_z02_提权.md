...
* [CVE-2023-22809 sudo提权漏洞 | sudo 1.8.0-sudo 1.9.12p1(sudo>=1.8.0 or sudo <=1.9.12p1)](https://mp.weixin.qq.com/s/uiAEnK5tqkKh0bqWPoTIKg)
...
* [较新Linux内核的提权 CVE-2018-18955](https://www.freebuf.com/news/197122.html) [Download](https://gitlab.com/exploit-database/exploitdb-bin-sploits/-/raw/main/bin-sploits/45886.zip)
* [CVE-2023-32233 漏洞（附EXP）](https://mp.weixin.qq.com/s/2fN7VM0-xbCqUo685u0mJw)
* [CVE-2023-32233：Linux内核中的安全漏洞](https://mp.weixin.qq.com/s/jC3CkJuPg5W_mS0oSPfvGg)
...
* [linux内核版本：v5.11-rc1 至 v6.2-rc5 | 【漏洞复现】linux提权（CVE-2023-0386）环境搭建与复现](https://mp.weixin.qq.com/s/Z6sVuMrYMZV8WD6z1-U95Q)
* CVE-2016-5195
* CVE-2017-16995
* CVE-2019-7304
* CVE-2019-13272
